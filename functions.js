const { createVariable } = require('./src/utils/helper')
require('./src/utils/classes/Format')
require('./src/utils/healperVariables')
...
module.exports = { onOpen, onLinear, onClose, defineMachine, onSection, onSectionEnd, onCircular, onRapid, onCycle, onCycleEnd, onCyclePoint}